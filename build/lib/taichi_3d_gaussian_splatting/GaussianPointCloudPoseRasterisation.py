...
class GaussianPointCloudPoseRasterisation(torch.nn.Module):
    @dataclass
    class GaussianPointCloudPoseRasterisationConfig(YAMLWizard):
    ...
    def __init__(
        self,
        config: GaussianPointCloudPoseRasterisationConfig,
            ...
            def backward(ctx, grad_rasterized_image, grad_rasterized_depth,
                ...
                if ctx.needs_input_grad[0] or ctx.needs_input_grad[1]:
                    ...
                    if backward_valid_point_hook is not None:
                        ...
                        backward_valid_point_hook_input = GaussianPointCloudPoseRasterisation.BackwardValidPointHookInput(
                            point_id_in_camera_list=point_id_in_camera_list,
    ...
    def forward(self, input_data: GaussianPointCloudPoseRasterisationInput):
