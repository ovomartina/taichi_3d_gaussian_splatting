...
def main(): # groundtruth_voxel_grid_path, reconstructed_voxel_grid_path
    ...
    mesh_reconstructed =  o3d.io.read_point_cloud("output/replica_colmap/room_1_high_quality_500_frames_bundle_adjustment_continuous_gt_lidar_new/point_clouds/completePointSet_aligned_icp.ply")
    ...
    o3d.io.write_voxel_grid("output/replica_colmap/room_1_high_quality_500_frames_bundle_adjustment_continuous_gt_lidar_new/point_clouds/voxel_completePointSet_aligned_icp.ply", voxel_grid_reconstruction)
