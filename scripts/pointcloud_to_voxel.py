...
def main(): # groundtruth_voxel_grid_path, reconstructed_voxel_grid_path
    ...
    mesh_reconstructed =  o3d.io.read_point_cloud("/media/scratch1/mroncoroni/git/taichi_3d_gaussian_splatting/output/sugar/completePointSet_aligned_icp.ply")
    ...
    o3d.io.write_voxel_grid("/media/scratch1/mroncoroni/git/taichi_3d_gaussian_splatting/output/sugar/voxelized_completePointSet_aligned_icp.ply", voxel_grid_reconstruction)
